...
registerOnClick('cancha', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam7', 'cancha', 1, function() {}, 0);
}, function(event) {});

registerOnClick('atardecer', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam1', 'atardecer', 1, function() {}, 0);
}, function(event) {});

registerOnClick('moto', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam6', 'moto', 1, function() {}, 0);
}, function(event) {});

registerOnClick('flores', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam3', 'flores', 1, function() {}, 0);
}, function(event) {});

registerOnClick('calle', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam4', 'calle', 1, function() {}, 0);
}, function(event) {});

registerOnClick('edificios', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam5', 'edificios', 1, function() {}, 0);
}, function(event) {});

registerOnClick('comida', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam2', 'comida', 1, function() {}, 0);
}, function(event) {});
